...
{
    public function createApprovalSteps($sppdId, $flowId)
    {
    ...
    public function createApprovalStepsReport($reportId, $flowId)
    {

        DB::table('tr_report_approvals')
        ...
        */
        ...
        $sppd = TrSppd::find($report->sppd_id);

        if (!$sppd) {
            throw new \Exception("SPPD tidak ditemukan untuk report {$reportId}");
        }
        ...
        */
        ...
        if (!$requester) {
            throw new \Exception("Requester tidak ditemukan");
        }
        ...
        */
        ...
        foreach ($flows as $flow) {
            ...
            */
            ...
            DB::table('tr_report_approvals')->insert([
